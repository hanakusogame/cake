...
export class MainScene extends g.Scene {
	...
	constructor(param: g.SceneParameterObject) {
		...
		this.loaded.add(() => {
			...
			//スコア
			uiBase.append(new g.Sprite({ scene: this, src: this.assets["score"], x: 375, y: 5, height: 32 }));
			let score = 0;
			...
			//何問目か
			uiBase.append(new g.Sprite({ scene: this, src: this.assets["score"], x: 300, y: 5, height: 32, srcY: 32 }));
			...
			//タイム
			uiBase.append(new g.Sprite({ scene: this, src: this.assets["time"], x: 0, y: 0 , scaleY:0.6, scaleX:0.6}));
			const labelTime = new g.Label({ scene: this, font: numFont, fontSize: 18, text: "70", x: 33, y: 10 });
