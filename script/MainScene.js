...
var MainScene = /** @class */ (function (_super) {
    ...
    function MainScene(param) {
        ...
        param.assetIds = [
            ...
            "select", "clear", "cake", "comp", "miss", "shadow",
            "config", "volume", "test", "glyph72", "number_w", "number_b", "number_p", "number_y",
        ...
        _this.loaded.add(function () {
            ...
            //const bg = new g.FilledRect({ scene: this, width: 640, height: 360, cssColor: "#CCCCCC", opacity: 0 });
            _this.append(bg);
            ...
            //スコア
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 375, y: 5, height: 32 }));
            var score = 0;
            ...
            //何問目か
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 300, y: 5, height: 32, srcY: 32 }));
            ...
            //タイム
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["time"], x: 0, y: 0, scaleY: 0.6, scaleX: 0.6 }));
            var labelTime = new g.Label({ scene: _this, font: numFont, fontSize: 18, text: "70", x: 33, y: 10 });
